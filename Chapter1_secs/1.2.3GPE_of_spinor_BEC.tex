\section{GPE of spinor BEC}
When we add the spin degree of freedom, we need to consider the spin dependent potential the spin interaction in the two particle scattering process. For two spin-1 particles, their total angular momentum $F$ can be 0 or 2, corresponding to scattering channel 0 and channel 2. Their scattering length is different in the both channels and the s-wave pseudo-potential is  
\begin{equation}
