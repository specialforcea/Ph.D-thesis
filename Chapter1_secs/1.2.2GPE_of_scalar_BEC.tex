...
For a dilute and cold gas, it is proper to approximate the interaction with two-body collisions. At low energy, the two body collision interaction can be represented by the s-wave pseudopotential which is characterized by s-wave scattering length.
\begin{equation}
