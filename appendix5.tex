...
As shown in Fig.~\ref{fig:append1}, an optical ray hit the edge of a lens is focused to the focal point and form an angle $\theta_0$ with $x$-axis. After the phase plate, the speckle beam diverges at an angle $\Delta \theta$, and the diverged beams form angles $\theta_1$ and $\theta_2$ with the $x$-axis.
