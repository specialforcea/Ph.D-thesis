...
The Nobel Lecture of W.D.Phillips, {\it Laser cooling and trapping of neutral atoms} \cite{phillips1998nobel} tells a great story of the development of laser cooling techniques since the late 1970s. It is recommended for readers who want to learn not only development of the laser cooling research field but also how researchers approach new physics and technology in a close view. It is aspiraing to learn the mature technology that cold atom researcher uses on a daily basis to expand the boundary of physics results from the intelligence, efforts and persistent pursuit of the early generation of physicists.    
...
In this chapter, we use $^{87} {\rm Rb}$ as an example. Start from its energy level, its interaction with light and magnetic field and then discuss the laser cooling techniques that is essential to make BEC.  
