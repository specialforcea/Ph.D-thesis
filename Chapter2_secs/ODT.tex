...
The recoil limit of Sisyphus Laser Cooling was not sufficient to cool atoms below the critical temperature. It was later achieved using evaporative cooling \cite{ketterle1996evaporative,aspect1988laser}, and has since been widely used as the last step to make BECs. Evaporative cooling can be done in an optical dipole trap in which the trap depth can be easily controlled.
