...
For the ground state of $^{87} {\rm Rb}$, the quantum number of orbital angular momentum ${\bf L}$ is 0 and the first excited state $L = 1$. When we consider the spin of the single electron in the outer shell of the atom, $S = 1/2$ and the interaction between spin and orbital angular momentum ${\bf L} \cdot {\bf S}$, the excited state splits into a fine-structure doublet. The total electron angular momentum 
\begin{equation}
    {\bf J} = {\bf L} + {\bf S}    
\end{equation}
becomes a good quantum number. For the ground state  $L = 0$, $S = 1/2$, $J = 1/2$. The ground state is labeled as $5^2S_{1/2}$ where the atomic states are described by term symbols of the form
\begin{equation}
    ^{2S+1}L_J.
\end{equation}
...
\begin{equation}
    {\bf F} = {\bf J} + {\bf I}.    
\end{equation}
The nuclear spin of $^{87} {\rm Rb}$ is 3/2, so as shown in Fig.~(\ref{fig:D1andD2}), $^{87} {\rm Rb}$ ground state splits into hyperfine states $\ket{F=1}$ and $\ket{F=2}$. The excited state $5^2S_{1/2}$ splits into hyperfine states $\ket{F=1}$ and $\ket{F=2}$.And the excited state $5^2P_{3/2}$ splits into hyperfine states $\ket{F=1}, \ket{F=2},\ket{F=3} and \ket{F=4}$. The Hamiltonian that leads to hyperfine split consist of magnetic dipole interaction and electric quadrupole interaction,
\begin{equation}
