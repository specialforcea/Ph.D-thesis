...
\end{equation}
The frame transformation and the removal of the oscillating term are named after rotating wave approximation (RWA). It is widely used in atomic physics when atoms interact with near resonance optical field, and satisfying the condition $\delta \ll \omega_0, \omega$.
...
\end{equation}
the state represented by $\hat{\rho}$ is a pure state, otherwise, it is a mixed state. In quantum mechanics, the probability amplitude of the states bear the full information, probability and coherence. The density operator representation loses the information of coherence of some states. 
