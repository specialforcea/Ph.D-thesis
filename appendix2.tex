...
For field-field correlation function
\begin{align}
...
In the free propagation case, the original calculation results are
In case one
\begin{equation}
    \begin{cases}
...
With a lens, 
\begin{align}
\frac{C_E({\bf r}_1,{\bf r}_2;z)}{E_0^2} =& \frac{k_0^2w^2}{4z^2D} \exp\left[-i\left(\frac{k_0}{2z} + \frac{z_L^2AB}{2Dz^2}\right)({\bf r}_1^2 - {\bf r}_2^2)\right]\label{eq:C_E}\\
