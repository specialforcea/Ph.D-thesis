...
Here we numerically study the deceleration of a SOBEC initially moving in a speckle potential using the time-dependent Gross-Pitaevskii equation (GPE).
...
\end{align}
is a non-perturbative dynamical description ~\cite{erdHos2010derivation} of a large number of interacting identical bosons occupying the same spatial mode $\Psi({\bf r}, t)$, normalized to the total atom number, $N=\int d^3{\bf r} |\Psi({\bf r}, t)|^2$.
...
\end{equation}
For compactness of notation, here and below, we shall omit the functional dependence of $\psi$ on $x$ and $t$.
...
The average speckle potential $h\times 200\ {\rm Hz} \approx 0.05\Er$ was selected to be weak enough to cause no trapping effect yet strong enough to produce significant deceleration within $16 {\rm ms}$.
