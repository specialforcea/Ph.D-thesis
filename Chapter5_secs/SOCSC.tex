...
The resulting dispersion relations, plotted in Fig.~\ref{fig:Dispersion relations} for $\delta = 0$ and $\Or = 1\Er$, have energies $E^\pm(q)$  labeled by $q$ along with $\pm$ to indicate if they are in the upper or lower band.
