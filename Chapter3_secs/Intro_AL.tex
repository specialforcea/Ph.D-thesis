...
Under the following two conditions, it was proved the wave function will be localized in a small region without diffusion. Here localization means at $t=0$, starting at site j, $a_j(0) = 1$, and $a_j(\infty)$ remains finite.
\begin{itemize}
...
\end{align}
The infinite series describe the high-order scattering processes shown by a diagram in Fig.~1 of \cite{anderson1958absence}, diffusion happens if the initial state goes through different scattering paths that constructively interfere at other sites.  
The term 
\begin{equation}
