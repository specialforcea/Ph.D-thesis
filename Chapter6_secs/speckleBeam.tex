...
The second is that the beam width along $\ex$ should uniformly illuminate the elongated atomic ensemble (with an expected diameter of about $50\ \mu{\rm m}$).
...
The requirement that the correlation length along $\ey$ be large implies that at the diffuser plate, the beam is much smaller along $\ey$ than along $\ex$.

To satisfy these joint requirements, we created the speckle beam shown in Fig.~\ref{fig:design}(a), which begins with a $532{\rm nm}$ laser beam emanating from an optical fiber. 
